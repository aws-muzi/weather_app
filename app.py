...
os.environ['OPENAI_API_KEY'] = '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'
...
def main ():
    ...
    # CSS modifications for black background
    st.markdown(
        """
        <style>
        body {
    ...
    image = Image.open('heavy-rain-drop-at-the-road-surface-bokeh-background-photo.jpg')
